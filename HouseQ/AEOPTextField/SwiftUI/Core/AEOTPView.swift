...
public struct AEOTPView: View {
    ...
    public init(
        text: Binding<String>,
        slotsCount: Int = 4,
        width: CGFloat = UIScreen.main.bounds.width * 0.76,
        height: CGFloat = 72,
        otpDefaultCharacter: String = "",
        otpBackgroundColor: UIColor = .clear,
        otpFilledBackgroundColor: UIColor = .white,
        otpCornerRaduis: CGFloat = 16,
        otpDefaultBorderColor: UIColor = .gray,
        otpFilledBorderColor: UIColor = .orange,
        otpDefaultBorderWidth: CGFloat = 1,
        otpFilledBorderWidth: CGFloat = 1,
        otpTextColor: UIColor = .black,
        otpFontSize: CGFloat = 12,
        otpFont: UIFont = UIFont.systemFont(ofSize: 34),
        isSecureTextEntry: Bool = false,
        enableClearOTP: Bool = true,
        onCommit: (() -> Void)? = nil
    ) {
        self._text = text
...
struct AEOTPView_Previews: PreviewProvider {
    static var previews: some View {
        AEOTPView(text: .constant(""))
